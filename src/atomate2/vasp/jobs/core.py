...
from atomate2.vasp.sets.core import (
    ...
    ## New set used in Static Calculations of perturbed structures generated by Hiphive
    MPStaticSetGenerator,
    LatticeDynamicsRelaxSetGenerator
)
...
__all__ = [
    ...
    ## New maker using MPStatic set to perform Static Calculations of perturbed structures generated by Hiphive
    "MPStaticMaker",
...
@dataclass
class LatticeDynamicsRelaxMaker(BaseVaspMaker):
    """
    Maker to create VASP relaxation jobs.
    ...
    name: str = "relax"
    input_set_generator: VaspInputGenerator = field(default_factory=LatticeDynamicsRelaxSetGenerator)
...
class MPStaticMaker(BaseVaspMaker):
    """
    Maker to create VASP static jobs with MPStatic set.
    ...
    name: str = "MPStatic"
    input_set_generator: VaspInputGenerator = field(default_factory=MPStaticSetGenerator)
